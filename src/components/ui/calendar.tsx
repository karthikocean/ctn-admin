  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_today: "bg-slate-100 text-foreground font-semibold border border-slate-200",
        day_outside:
        ...
        day_disabled: "!text-muted-foreground/30 !opacity-30 !cursor-not-allowed !pointer-events-none !bg-transparent hover:!bg-transparent",
